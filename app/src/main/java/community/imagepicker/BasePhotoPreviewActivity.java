...
import community.imagepicker.util.AnimationUtil;
import community.imagepicker.widgets.PhotoPreview;
...
public class BasePhotoPreviewActivity extends Activity implements OnPageChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ResFinder.getLayout("umeng_commm_imagepicker_photopreview"));
