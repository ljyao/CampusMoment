...
public class AnimatedGifDrawable extends AnimationDrawable {
    ...
    private static LruCache<String, Bitmap> imageCache = LruCaCheFactory.getEmojiCache();
    Context mContext;
    private int mCurrentIndex = 0;
    private UpdateListener mListener;

    public AnimatedGifDrawable(Context context, String num,
    ...
    public Drawable getDrawable() {
        ...
        int val = ScreenUtils.dp2px(30, mContext);
